...
class Tecnico extends Component {
  ...
  addTecnico = event => {
    ...
    var newTecnico = this.state;
        ...
        if(!this.state.edit) {
            const url = 'https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/tecnicos/';
            ...
            const url ='https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/tecnicos/'+this.state.id;
      ...
      deleteTecnico = (id) => event => {
        ...
        const url ='https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/tecnicos/'+id;
      ...
      loadTecnico()
      {
          axios.get('https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/tecnicos')
          .then (res => {
