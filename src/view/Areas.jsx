...
class Areas extends Component {
  ...
  addArea = event => {
    ...
    if(!this.state.edit) {
        const url = 'https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/areas/';
       ...
       // newArea.areas.push(this.frmNomArea.value);
        ...
        const url ='https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/areas/'+this.state.id;
  ...
  deleteArea = (id) => event => {
    ...
    const url ='https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/areas/'+id;
  ...
  loadAreas()
  {
      axios.get('https://ups-lb-api1-cheerful-lemur-bm.mybluemix.net/api/areas')
      .then (res => {
